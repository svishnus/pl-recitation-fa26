...
@chunk[<third-tests>
       (check-expect (my-third (list 2 3)) 'TODO)
       (check-expect (my-third 0) 'TODO)
       (check-expect (my-third (list '(2 3) 2 4 5 6 7)) 'TODO)
       (check-expect (my-third (list 1 2 3 4)) 'TODO)

       (check-expect (other-third (list 2 3)) 'TODO)
       (check-expect (other-third 0) 'TODO)
       (check-expect (other-third (list '(2 3) 2 4 5 6 7)) 'TODO)
       (check-expect (other-third (list 1 2 3 4)) 'TODO)]
